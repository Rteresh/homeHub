...
- Реальные пути файлов не отдаются пользователю.
- Файлы выдаются через Django endpoints с проверкой прав.
- Telegram-вход использует одноразовые токены со сроком действия 10 минут.
- Для постоянного публичного доступа нужен HTTPS, домен и более строгие production-настройки Django.
